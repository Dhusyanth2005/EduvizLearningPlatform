...
const Message = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io("https://eduvizbackend.onrender.com", {
    ...
    const fetchMessages = async () => {
      try {
        const response = await axios.get("https://eduvizbackend.onrender.com/api/messages");
    ...
    try {
      ...
      if (selectedImage) {
        try {
          ...
          const uploadResponse = await axios.post(
            "https://eduvizbackend.onrender.com/api/messages/upload",
            formData,
            {
              headers: {
      ...
      try {
        ...
        const response = await axios.post(
          "https://eduvizbackend.onrender.com/api/messages",
          messageData
        );
