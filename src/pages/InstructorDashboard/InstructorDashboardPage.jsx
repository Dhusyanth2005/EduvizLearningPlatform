...
function CreateModelForm({ onModelCreated, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://eduvizbackend.onrender.com/create-model", {
        method: "POST",
        body: formData,
        credentials: "include",
      });
...
function InstructorDashboard() {
    ...
    const fetchUserAndModels = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://eduvizbackend.onrender.com/api/models/instructor/${userData.id}`,
  ...
  const handleModelCreated = async (newModel) => {
    try {
      ...
      const response = await fetch(
        `https://eduvizbackend.onrender.com/api/models/instructor/${user.id}`,
        { headers: { Authorization: `Bearer ${token}` }, credentials: "include" }
      );
