...
const SettingsPage = () => {
      ...
      if (e.target.files && e.target.files[0]) {
        ...
        try {
          ...
          if (response.data.profilePicture) {
            ...
            setPreviewImage(newProfilePicture); // Use Cloudinary URL directly
        ...
        <div className={styles.settingsContainer}>
          <div className={styles.profileImageContainer}>
            <div className={`${styles.profileAvatar} ${styles.largeAvatar}`} onClick={triggerFileInput}>
              {previewImage ? (
                <img src={previewImage} className={styles.avatarImage} />
              ) : (
  ...
  const ViewProfile = () => {
    const profileImageUrl = userData.profilePicture || null; // Use Cloudinary URL directly
